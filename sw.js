const C='climpilot-next-121-cockpit';
self.addEventListener('install',e=>{e.waitUntil(caches.open(C).then(c=>c.addAll(['./','./index.html','./next-theme.css','./next-pro.css','./next-addons.js','./next-regime.js','./next-siren.js','./next-icons.js','./next-statut.js','./next-pdf.js','./next-activite.js','./next-relance.js','./next-commande.js','./manifest.json','./icon-192.png','./icon-512.png'])));self.skipWaiting();});
